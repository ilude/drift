...
import { ENGINE_TYPES, brachistochroneDeltaV, brachistochroneTime, G_ACCEL, rocketDeltaV, exhaustVelocity } from '../math/ship-physics.js';
        ...
        state.bodyMeshes
            ...
            .forEach(e => {
                ...
                if (e.data.distance !== r1 && accelMS2 > 0) {
                    const dv = brachistochroneDeltaV(r1, e.data.distance, accelMS2);
                    const days = brachistochroneTime(r1, e.data.distance, accelMS2);
