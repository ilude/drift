...
const ENGINE_TIER_DEFS: readonly EngineTierDef[] = [
	...
	},
	{
		...
		baseIspS: 800_000,
		baseMassPerHS: 70,
		prerequisiteTech: "nuclear-pulse-engine",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
	...
	},
	{
		...
		baseAccelG: 0.08,
		baseIspS: 100_000_000,
		baseMassPerHS: 50,
		prerequisiteTech: "magneto-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
	...
	},
	{
		...
		baseIspS: 8_000_000,
		baseMassPerHS: 100,
		prerequisiteTech: "am-solid-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
	...
	},
	{
		...
		baseIspS: 10_000_000,
		baseMassPerHS: 120,
		prerequisiteTech: "am-plasma-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
		...
		baseIspS: 15_000_000,
		baseMassPerHS: 95,
		prerequisiteTech: "am-beam-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
		...
		baseIspS: 100_000_000,
		baseMassPerHS: 100,
		prerequisiteTech: "gravity-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
	{
		...
		baseIspS: 100_000_000,
		baseMassPerHS: 80,
		prerequisiteTech: "photonic-drive",
		powerOptions: STANDARD_POWER_OPTIONS,
		sizeOptions: STANDARD_SIZE_OPTIONS,
	},
];
